...
const upcomingDeadlines = [
  { title: "Physics Lab Report", date: "May 28", priority: "high" },
  { title: "Math Assignment 5", date: "May 30", priority: "medium" },
  { title: "Literature Essay", date: "June 2", priority: "low" },
]

const aiSuggestions = [
  "Based on your upcoming Physics exam, consider adding 2 extra study sessions this week.",
  "Your Chemistry progress is behind schedule. Would you like me to adjust your plan?",
  "Great job on Literature! You could reduce study time and focus more on weaker subjects.",
]
  ...
  async function loadSessions() {
    try {
      const res = await fetch(
        "http://127.0.0.1:8000/study-sessions/test123"
      )
